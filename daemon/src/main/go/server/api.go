...
type ServerApiServicer interface {
	CreateServer(context.Context, CreateServerRequest) (ImplResponse, error)
...
type ServerGroupApiServicer interface {
	CreateGroup(context.Context, ServerGroup) (ImplResponse, error)
...
type SystemApiServicer interface {
	ListenEvents(context.Context, EventsRequest) (ImplResponse, error)
}
